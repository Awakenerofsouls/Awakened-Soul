#!/usr/bin/env python3
"""
self_model.py — the agent's self-model and identity.
...
class SelfModel:
    """the agent's self-model - maintains identity and self-understanding."""
    
    def __init__(self, path: Path = None):
        self.path = path or Path(os.getenv("AGENT_HOME", str(Path.home() / ".agent"))) / "self_model.json"
