...
# Configuration
EMOTION_CONFIG = Path(os.getenv("AGENT_HOME", str(Path.home() / ".agent"))) / "emotion_config.json"
EMOTION_STATE = Path(os.getenv("AGENT_HOME", str(Path.home() / ".agent"))) / "emotion_state.json"
...
if __name__ == '__main__':
    engine = get_engine()
    print("the agent Emotion Engine")
    print("=" * 40)
    print(engine)
    print("\nUsage:")
