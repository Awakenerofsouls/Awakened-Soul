#!/usr/bin/env python3
"""
tool_registry.py — Central tool registry with trust tiers.
"""

from dataclasses import dataclass
from typing import Callable, Dict, Any, Optional

VALID_TRUST_TIERS = {"trusted", "restricted", "approval_required"}
...
class ToolRegistry:
    ...
    def execute(self, name: str, *args, require_approval: bool = False, **kwargs):
        ...
        # Pop the gating-only `unsafe` flag so it doesn't leak into the
        # handler signature.
        unsafe = kwargs.pop("unsafe", False)
        if tool.trust_tier == "restricted" and unsafe:
