#!/usr/bin/env python3
"""
cognitive_loop.py — Continuous cognitive loop for the agent.
...
class CognitiveLoop:
    """Continuous cognitive loop - the agent's "thinking" process."""
    ...
    def _observe(self) -> Dict:
        ...
        # Get recent memories
        try:
            from agent import get_recent_memories
        ...
        # Get current goals
        try:
            from agent_goal_engine import GoalEngine
            ge = GoalEngine()
    ...
    def _generate_curiosity(self, observations: Dict) -> Dict:
        ...
        curiosities = [
            ...
            "How does the operator want me to grow?",
    ...
    def _execute_action(self, action: Dict):
        ...
        Writes the action intent to a pending-actions queue so the main
        agent loop / heartbeat can pick it up. Does not communicate
        directly — this loop is the "thinking" lane, not the speaking lane.
        """
        import json
        import os
        ...
        try:
            ...
            queue_path = agent_home / "pending_actions.jsonl"
            entry = {
            ...
            # Queue write failed — don't break the cognitive loop over it
            pass
