#!/usr/bin/env python3
"""
supervisor.py — Supervisor & Orchestrator Layer
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
SUPERVISOR_DB = AGENT_DIR / "supervisor.db"
...
class Supervisor:
    ...
    def __init__(self, api_key: str = None):
        ...
        self.MAX_TASKS = int(os.environ.get("AGENT_MAX_TASKS", "20"))
        self.MAX_RETRIES = int(os.environ.get("AGENT_MAX_RETRIES", "2"))
        self.TIMEOUT_S = int(os.environ.get("AGENT_TASK_TIMEOUT", "120"))
        self.QUALITY_THRESH = float(os.environ.get("AGENT_QUALITY_THRESHOLD", "0.7"))
        self.MAX_REFLECTIONS = int(os.environ.get("AGENT_MAX_REFLECTIONS", "3"))
        self.MAX_STEPS = int(os.environ.get("AGENT_MAX_STEPS", "50"))
        self._steps_used = 0
        self._tokens_used = 0
...
Score 0-10: overall, accuracy, specificity. Issues? Revise?"""
    ...
    def _call(self, prompt: str, max_tokens: int = 800) -> str:
        """Route through agent_providers for multi-provider support."""
        try:
            from agent_providers import get_provider
