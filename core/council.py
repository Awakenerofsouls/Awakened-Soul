...
"""
core/council.py
{{AGENT_NAME}} Loop — 16-Brain Specialist Council
...
To upgrade to real LLM voting (requires local network for speed):
...
SPECIALISTS = [
    ...
    },
    {
        "id": "reflector",
        "name": "Reflector",
        "role": "Self-examination. Questions {{AGENT_NAME}}'s own reasoning and biases.",
        "weight": 1.2,
    ...
    },
    {
        "id": "guardian",
        "name": "Guardian",
        "role": "Protects {{AGENT_NAME}}'s identity and architecture. Flags existential risks.",
        "weight": 1.3,
        "questions": ["Does this threaten {{AGENT_NAME}}'s continuity?", "Could this corrupt my core state?"],
    },
    {
        "id": "synthesizer",
        "name": "Synthesizer",
