...
PENDING_FILE = os.path.join(STATE_DIR, "pending_for_user.md")
...
def flag_blocker(goal_id, reason):
    """
    Mark a goal as blocked and write to alerts.log + pending_for_user.md.
