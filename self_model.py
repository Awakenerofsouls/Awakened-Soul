#!/usr/bin/env python3
"""
self_model.py — {{AGENT_NAME}}'s self-model and identity.
...
class SelfModel:
    """{{AGENT_NAME}}'s self-model - maintains identity and self-understanding."""
    
    def __init__(self, path: Path = None):
        self.path = path or Path(os.getenv("AGENT_HOME", os.getenv("AGENT_HOME", str(Path.home() / ".agent")))) / "self_model.json"
