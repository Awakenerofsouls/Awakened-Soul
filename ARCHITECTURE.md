# ARCHITECTURE.md — {{AGENT_NAME}} Living Agent Framework

## Overview
Nexus {{AGENT_NAME}} is a framework that transforms a base AI agent into a living, present companion. It provides memory, identity, skills, and presence — not as features, but as a second nature that grows over time.
