...
if __name__ == '__main__':
    print("{{AGENT_NAME}} Memory System")
    print("=" * 40)
    
    manager = get_memory_manager()
    
    # Test
    manager.remember("Met with {{USER_NAME}} today", context="first meeting", importance=8)
    manager.remember("{{USER_NAME}} likes AI", memory_type='semantic', importance=7)
