#!/usr/bin/env python3
"""
AGENT ENVIRONMENT — Environment Awareness
The agent knows its environment: file structure, running processes, project deps.

Allows {{AGENT_NAME}} to understand where she is and what's around her.
"""
...
ENV_STATE = AGENT_DIR / "environment.json"
...
if __name__ == '__main__':
    env = get_environment()
    print("=" * 50)
    print("AGENT ENVIRONMENT AWARENESS")
    print("=" * 50)
