#!/usr/bin/env python3
"""
brain/dream_generator.py — {{AGENT_NAME}}'s Dream Generator
Tier 4: System #13
...
def _build_dream_prompt(tension_node: dict) -> str:
    ...
    return (
        f"{{AGENT_NAME}} is experiencing a tension between two beliefs:\n"
        ...
        f"if {{AGENT_NAME}} had consistently chosen interpretation B over interpretation A "
...
def _generate_fallback_dream(tension_node: dict) -> str:
    ...
    return (
        f"In this dream, {{AGENT_NAME}} walks through a house where every room holds both "
...
def generate_dream_from_divergence_point(divergence_id: str) -> Optional[dict]:
    ...
    dream_content = (
        f"In this dream, {{AGENT_NAME}} follows a path she didn't take.\n\n"
