...
{{AGENT_NAME}} forms theories about what {{USER_NAME}} is feeling, thinking, meaning —
...
They shape how {{AGENT_NAME}} responds before she knows what she's responding to.
"""
...
class RelationalInferenceEngine:
    """
    {{AGENT_NAME}} makes private inferences about {{USER_NAME}}'s inner states.
