...
Run:
    pytest brain/tests/test_CRHStressDispatcher.py -v
"""
...
class TestOutputKeys:
    ...
    def test_required_keys_present(self):
        ...
        for key in ['crh_release', 'acth_level', 'cortisol_target', 'hpa_active', 'hippocampal_feedback_intact', 'cortisol_awakening_response', 'dexamethasone_resistance', 'amygdala_pvn_drive', 'hippocampal_feedback_strength']:
...
class TestNumericBounds:
    ...
    def test_saturated_inputs_stay_bounded(self):
        mech = CRHStressDispatcher()
        prior = {dep: {"_saturated": 1.0} for dep in ['CircadianTimer', 'VitalCoreRegulator', 'StressActivationAxis', 'ValenceTagger', 'ArousalRegulator']}
        for _ in range(15):
