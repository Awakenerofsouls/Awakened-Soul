...
class TestOutputKeys:
    def test_required_keys_present(self):
        ...
        for key in ['bladder_urgency', 'detrusor_contraction', 'sphincter_relaxation', 'micturition_command', 'cortical_inhibition_strength', 'brain_micturition_urgency']:
...
class TestNumericBounds:
    ...
    def test_saturated_inputs_stay_bounded(self):
        mech = MicturitionCenter()
        prior = {dep: {"_saturated": 1.0} for dep in ['VisceralSignalRelay', 'MedialPrefrontal', 'VLPOSleepActive']}
        for _ in range(15):
