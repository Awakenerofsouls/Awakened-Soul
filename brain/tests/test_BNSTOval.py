"""
Behavioral tests for BNSTOval.
"""

import asyncio

from brain.mechanisms.BNSTOval import BNSTOval
...
class TestOutputKeys:
    def test_required_keys_present(self):
        ...
        for key in ['bnst_ov_drive', 'crh_peptide_release', 'vta_stress_modulation', 'chronic_stress_signal', 'bnst_ov_state']:
...
class TestNumericBounds:
    ...
    def test_saturated_inputs_stay_bounded(self):
        mech = BNSTOval()
        prior = {dep: {"_saturated": 1.0} for dep in ['ValenceTagger', 'BasalAmygdala', 'ArousalRegulator', 'ParaventricularAutonomic', 'CRHStressDispatcher']}
        for _ in range(15):
