...
class TestOutputKeys:
    def test_required_keys_present(self):
        ...
        for key in ['portal_flow_strength', 'rh_transmission_fidelity', 'anterior_pituitary_activation', 'portal_leakage', 'endocrine_permissiveness']:
...
class TestNumericBounds:
    ...
    def test_saturated_inputs_stay_bounded(self):
        mech = PortalInterfaceHub()
        prior = {dep: {"_saturated": 1.0} for dep in ['ReleasingHormoneHub', 'GnRHReintegration', 'AutonomicSecretionLink', 'VLPOSleepActive', 'ThyroidAxisController', 'DirectHormonalPituitaryLink', 'CRHStressDispatcher']}
        for _ in range(15):
