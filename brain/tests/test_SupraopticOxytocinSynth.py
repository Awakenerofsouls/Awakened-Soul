...
class TestOutputKeys:
    def test_required_keys_present(self):
        ...
        for key in ['oxytocin_level', 'uterine_contraction_drive', 'milk_ejection_drive', 'social_bonding_signal', 'stress_buffering_oxytocin']:
...
class TestNumericBounds:
    ...
    def test_saturated_inputs_stay_bounded(self):
        mech = SupraopticOxytocinSynth()
        prior = {dep: {"_saturated": 1.0} for dep in ['UterineStretchReceptor', 'EstrogenSignal', 'NippleSucklingSignal', 'SomatosensoryCortexTouch', 'CRHStressDispatcher']}
        for _ in range(15):
