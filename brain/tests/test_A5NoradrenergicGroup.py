"""
Behavioral tests for A5NoradrenergicGroup.

Run:
    pytest brain/tests/test_A5NoradrenergicGroup.py -v
"""

import asyncio

from brain.mechanisms.A5NoradrenergicGroup import A5NoradrenergicGroup
...
class TestOutputKeys:
    ...
    def test_required_keys_present(self):
        mech = A5NoradrenergicGroup()
        result = _run(mech.tick({"prior_results": {}}))
        for key in ['a5_drive', 'spinal_ne_visceral', 'bp_elevation_drive', 'pain_facilitation_a5', 'chemoreflex_modulation', 'a5_state', 'sympathetic_tone']:
...
class TestNumericBounds:
    ...
    def test_saturated_inputs_stay_bounded(self):
        mech = A5NoradrenergicGroup()
        prior = {dep: {"_saturated": 1.0} for dep in ['BaroreflexBalancer', 'VitalCoreRegulator', 'DescendingPainGate', 'CarotidBodyChemosensor', 'ArousalRegulator']}
        for _ in range(15):
