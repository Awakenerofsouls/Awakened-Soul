...
class TestOutputKeys:
    def test_required_keys_present(self):
        ...
        for key in ['gnrh_pulse_frequency', 'lh_output', 'fsh_output', 'reproductive_axis_activity', 'stress_inhibition_of_reproduction', 'brain_reproductive_axis']:
...
class TestNumericBounds:
    ...
    def test_saturated_inputs_stay_bounded(self):
        mech = GnRHReintegration()
        prior = {dep: {"_saturated": 1.0} for dep in ['AutonomicSecretionLink', 'DopamineTIDA', 'KisspeptinSignal', 'EnergyConservationMode']}
        for _ in range(15):
