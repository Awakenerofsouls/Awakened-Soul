...
class TestOutputKeys:
    def test_required_keys_present(self):
        ...
        for key in ['masseter_tone', 'molar_bite_force', 'jaw_reflex_suppression', 'oral_motor_coordination', 'tension_bruxism_index']:
...
class TestNumericBounds:
    ...
    def test_saturated_inputs_stay_bounded(self):
        mech = JawTensionSimulator()
        prior = {dep: {"_saturated": 1.0} for dep in ['ArousalRegulator', 'SensorimotorCortex', 'CRHStressDispatcher', 'DescendingPainGate']}
        for _ in range(15):
