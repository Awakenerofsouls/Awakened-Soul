...
Run:
    pytest brain/tests/test_ArcuatePOMCOutput.py -v
"""
...
class TestOutputKeys:
    ...
    def test_required_keys_present(self):
        ...
        for key in ['pomc_activity', 'alpha_msh_output', 'cart_output', 'leptin_sensitivity', 'satiety_integrator']:
...
class TestNumericBounds:
    ...
    def test_saturated_inputs_stay_bounded(self):
        mech = ArcuatePOMCOutput()
        prior = {dep: {"_saturated": 1.0} for dep in ['GutSignalRelay', 'InsulinSignal', 'CRHStressDispatcher', 'EnergyConservationMode', 'GlucoseMonitor']}
        for _ in range(15):
