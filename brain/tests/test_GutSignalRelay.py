"""
Behavioral tests for GutSignalRelay.
"""

import asyncio

from brain.mechanisms.GutSignalRelay import GutSignalRelay
...
class TestNumericBounds:
    ...
    def test_saturated_inputs_stay_bounded(self):
        mech = GutSignalRelay()
        prior = {dep: {"_saturated": 1.0} for dep in ['ArousalRegulator', 'ValenceTagger', 'Homeostat', 'PredictionErrorDrift']}
        for _ in range(15):
