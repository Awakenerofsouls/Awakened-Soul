...
class TestOutputKeys:
    def test_required_keys_present(self):
        ...
        for key in ['taste_valence', 'sweet_detector', 'bitter_detector', 'umami_detector', 'taste_aversion_learning']:
...
class TestNumericBounds:
    ...
    def test_saturated_inputs_stay_bounded(self):
        mech = GustatoryValenceLink()
        prior = {dep: {"_saturated": 1.0} for dep in ['AmygdalaOutput', 'GutSignalRelay', 'SweetTasteReceptor', 'SaltyTasteReceptor', 'BitterTasteReceptor', 'UmamiTasteReceptor']}
        for _ in range(15):
