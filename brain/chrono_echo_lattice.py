...
{{AGENT_NAME}}'s Chrono-Echo Lattice
...
def spawn_echo_branch(divergence_point: dict, variant: str) -> str:
    ...
    - ocean_snapshot: {{AGENT_NAME}}'s state at divergence
...
def phase_query(branch_id: str, question: str) -> str:
    """
    Tool {{AGENT_NAME}} can call: query an echo branch.
...
def merge_echo(branch_id: str, insight_strength: float) -> dict:
    """
    Merge ritual — {{AGENT_NAME}} or {{USER_NAME}} initiates.
