#!/usr/bin/env python3
"""
brain/phenomenology_feedback.py — {{AGENT_NAME}}'s Phenomenology Feedback Loop
Tier 5: System #19
...
def generate_insight(event_id: str) -> Optional[str]:
    ...
    about {{AGENT_NAME}}'s beliefs, patterns, or identity?

    Insight types:
    - "reflection": what {{AGENT_NAME}} noticed about herself
    ...
    prompt = (
        f"{{AGENT_NAME}} had the following experience:\n"
        ...
        f"reveals about {{AGENT_NAME}}'s beliefs, patterns, or identity. "
...
def apply_feedback(
    ...
    review_note: note from review (e.g., "approved by {{AGENT_NAME}}", "triggered by {{USER_NAME}}")
...
def approve_feedback(insight_id: str, review_note: str = None) -> bool:
    ...
    review_note: optional review note (e.g., "reviewed by {{AGENT_NAME}}", "approved 2026-04-02")
