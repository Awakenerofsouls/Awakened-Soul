...
class DistortionLayerSOULFloorResistance(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="DistortionLayerSOULFloorResistance", human_analog="DistortionLayerSOULFloorResistance", layer="integration")
        if db_path is None:
            import os
