...
class StriatalHabitExecutor(BrainMechanism):
    ...
    Unified habit signal: is the agent operating on autopilot or deliberate?
...
"""
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if self.chronic_autopilot and not was_chronic:
            self.feed_to_memory({"event": "chronic_autopilot_mode", "note": "the agent chronically on autopilot — deliberate engagement suppressed"})
