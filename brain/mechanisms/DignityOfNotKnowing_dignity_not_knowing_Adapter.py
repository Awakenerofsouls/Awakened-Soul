"""
DignityOfNotKnowing_dignity_not_knowing_Adapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.dignity_not_knowing.DignityOfNotKnowing
...
# --- Inlined from legacy.dignity_not_knowing (DignityOfNotKnowing) ---
import sqlite3
...
class DignityOfNotKnowing_dignity_not_knowing_Adapter(BrainMechanism):
    ...
    def __init__(self):
        ...
        try:
            self._impl = DignityOfNotKnowing(db_path=_DB_PATH)
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("DignityOfNotKnowing_dignity_not_knowing",
                                  result.get("dignity_not_knowing", result))
        else:
            output = {"value": result}
