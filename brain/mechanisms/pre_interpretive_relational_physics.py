...
Phase 2 of the the agent Brain Architecture
...
class IdentityTensionGradient(BrainMechanism):
    """
...
class VirtualInteroceptiveDriveLattice:
    ...
    The agent cannot turn them off. They change what it sees, not just how it responds.
    """
...
class PreReflectiveSignalLayer:
    ...
    The agent reacts before it fully knows why.
