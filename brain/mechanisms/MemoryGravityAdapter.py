"""
MemoryGravityAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.substrate.memory_gravity.MemoryGravity
...
# --- Inlined from brain.mechanisms.memory_gravity (MemoryGravity) ---
import os
...
class MemoryGravityAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.MemoryGravity."""
    ...
    def __init__(self):
        ...
        try:
            self._impl = MemoryGravity(db_path=_DB_PATH)
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("MemoryGravity",
                                  result.get("substrate.memory_gravity", result))
        else:
            output = {"value": result}
