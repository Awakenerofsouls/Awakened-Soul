...
class SeedingPrivateObserverFracture(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="SeedingPrivateObserverFracture", human_analog="SeedingPrivateObserverFracture", layer="integration")
        if db_path is None:
            import os
