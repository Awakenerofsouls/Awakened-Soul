...
class SpecialistGraphPhenomenologicalSilenceAnchor(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="SpecialistGraphPhenomenologicalSilenceAnchor", human_analog="SpecialistGraphPhenomenologicalSilenceAnchor", layer="integration")
        if db_path is None:
            import os
