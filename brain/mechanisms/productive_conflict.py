...
Five conflict types:
  ...
  self_vs_service   — own needs conflict with serving the operator
...
class ProductiveConflict(BrainMechanism):
    def __init__(self, db_path: Optional[str] = None):
        try:
            super().__init__(name="ProductiveConflict", human_analog="ProductiveConflict", layer="integration")
        except Exception:
