"""
AdaptiveGoalRefinerAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.life.AdaptiveGoalRefiner.AdaptiveGoalRefiner
...
# --- Inlined from brain.mechanisms.AdaptiveGoalRefiner (AdaptiveGoalRefiner) ---
import sqlite3,time
from pathlib import Path
import os
...
class AdaptiveGoalRefinerAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.AdaptiveGoalRefiner."""
    ...
    def __init__(self):
        ...
        try:
            self._impl = AdaptiveGoalRefiner()
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("AdaptiveGoalRefiner",
                                  result.get("life.AdaptiveGoalRefiner", result))
        else:
            output = {"value": result}
