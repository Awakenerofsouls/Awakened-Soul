"""
ExperiencePredictorAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.life.ExperiencePredictor.ExperiencePredictor
...
# --- Inlined from brain.mechanisms.ExperiencePredictor (ExperiencePredictor) ---
import sqlite3,time
from pathlib import Path
import os
...
class ExperiencePredictorAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.ExperiencePredictor."""
    ...
    def __init__(self):
        ...
        try:
            self._impl = ExperiencePredictor()
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("ExperiencePredictor",
                                  result.get("life.ExperiencePredictor", result))
        else:
            output = {"value": result}
