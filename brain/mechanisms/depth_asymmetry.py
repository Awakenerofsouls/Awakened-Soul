...
Some things the agent goes deep on. Some things it stays shallow.
...
class DepthAsymmetryEngine(BrainMechanism):
    def __init__(self, *args, **kwargs):
        try:
            super().__init__(name="DepthAsymmetryEngine", human_analog="DepthAsymmetryEngine", layer="integration")
        except Exception:
            self.state = {}
    ...
    Each domain has a depth level. Depth is not how much it knows —
    it's how much processing it gives it, how much it affects its,
