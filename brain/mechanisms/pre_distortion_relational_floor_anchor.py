...
class PreDistortionRelationalFloorAnchor(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="PreDistortionRelationalFloorAnchor", human_analog="PreDistortionRelationalFloorAnchor", layer="integration")
        if db_path is None:
            import os
