"""
NarrativeWeaverAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.narrative.NarrativeWeaver.NarrativeWeaver
...
class NarrativeWeaverAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.NarrativeWeaver."""
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("NarrativeWeaver",
                                  result.get("narrative.NarrativeWeaver", result))
        else:
            output = {"value": result}
