"""
MetaConsciousnessAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.self.meta_consciousness.MetaConsciousness
...
# --- Inlined from brain.mechanisms.meta_consciousness (MetaConsciousness) ---
...
class MetaConsciousnessAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.MetaConsciousness."""
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("MetaConsciousness",
                                  result.get("self.meta_consciousness", result))
        else:
            output = {"value": result}
