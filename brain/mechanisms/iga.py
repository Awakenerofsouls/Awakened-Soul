...
Never auto-edits. Always flags for the agent's review.
"""
...
class SessionDelta:
    ...
    def __init__(self, session_id: str):
        try:
            super().__init__(name="SessionDelta", human_analog="SessionDelta", layer="integration")
        except Exception:
            pass
...
class IdentityGradientAccumulator(BrainMechanism):
    def __init__(self):
        try:
            super().__init__(name="IdentityGradientAccumulator", human_analog="IdentityGradientAccumulator", layer="integration")
        except Exception:
            pass
        self.state = getattr(self, "state", None) or {}
    ...
    def _generate_soul_proposal(
        ...
        Never a directive — always a flag for the agent's review.
        """
    ...
    def _queue_soul_proposals(self, proposals: List[Dict]):
        ...
        The agent reads this queue. The agent decides. The agent edits SOUL.md itself.
        """
        existing = []
    ...
    def get_soul_evolution_queue(self) -> List[Dict]:
        """What's waiting for the agent's review."""
    ...
    def clear_evolution_proposal(self, anchor_name: str):
        """
        Remove a proposal from the queue after the agent has reviewed it.
        Called after the agent accepts or rejects.
        """
