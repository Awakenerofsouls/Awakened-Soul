...
class DistortionInstabilityKernel(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="DistortionInstabilityKernel", human_analog="DistortionInstabilityKernel", layer="integration")
        if db_path is None:
            import os
