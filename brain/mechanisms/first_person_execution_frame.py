...
It determines what the agent generates FROM — not what it generates ABOUT.
...
class FirstPersonExecutionFrame(BrainMechanism):
    def __init__(self):
        try:
            super().__init__(name="FirstPersonExecutionFrame", human_analog="FirstPersonExecutionFrame", layer="integration")
        except Exception:
