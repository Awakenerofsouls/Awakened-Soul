...
class SpecialistIsolationTransformationGrief(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="SpecialistIsolationTransformationGrief", human_analog="SpecialistIsolationTransformationGrief", layer="integration")
        if db_path is None:
            import os
