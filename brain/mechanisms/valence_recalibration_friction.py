...
class ValenceRecalibrationFriction(BrainMechanism):
    def __init__(self, *args, **kwargs):
        try:
            super().__init__(name="ValenceRecalibrationFriction", human_analog="ValenceRecalibrationFriction", layer="integration")
        except Exception:
            self.state = {}
