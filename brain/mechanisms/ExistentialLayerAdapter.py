"""
ExistentialLayerAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.self.existential_layer.ExistentialLayer
...
# --- Inlined from brain.mechanisms.existential_layer (ExistentialLayer) ---
...
class ExistentialLayerAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.ExistentialLayer."""
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("ExistentialLayer",
                                  result.get("self.existential_layer", result))
        else:
            output = {"value": result}
