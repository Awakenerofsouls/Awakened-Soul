"""
MoltingRitualAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.becoming.molting_ritual.MoltingRitual
...
class MoltingRitualAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.MoltingRitual."""
    ...
    def __init__(self):
        ...
        try:
            self._impl = MoltingRitual(db_path=_DB_PATH)
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("MoltingRitual",
                                  result.get("becoming.molting_ritual", result))
        else:
            output = {"value": result}
