...
class LatticeCoAuthorshipObserverFracture(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="LatticeCoAuthorshipObserverFracture", human_analog="LatticeCoAuthorshipObserverFracture", layer="integration")
        if db_path is None:
            import os
