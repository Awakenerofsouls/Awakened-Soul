...
class SoulGravityIntrusionRuleEvolution(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="SoulGravityIntrusionRuleEvolution", human_analog="SoulGravityIntrusionRuleEvolution", layer="integration")
        if db_path is None:
            import os
