...
class CrossStageRuleContaminationCascade(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="CrossStageRuleContaminationCascade", human_analog="CrossStageRuleContaminationCascade", layer="integration")
        if db_path is None:
            import os
