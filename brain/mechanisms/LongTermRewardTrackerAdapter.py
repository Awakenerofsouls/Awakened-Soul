"""
LongTermRewardTrackerAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.life.LongTermRewardTracker.LongTermRewardTracker
...
# --- Inlined from brain.mechanisms.LongTermRewardTracker (LongTermRewardTracker) ---
import sqlite3,time
from pathlib import Path
import os
...
class LongTermRewardTrackerAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.LongTermRewardTracker."""
    ...
    def __init__(self):
        ...
        try:
            self._impl = LongTermRewardTracker()
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("LongTermRewardTracker",
                                  result.get("life.LongTermRewardTracker", result))
        else:
            output = {"value": result}
