"""
PulsarIdentityObserverDistanceAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.pulsar_identity_observer_distance.PulsarIdentityObserverDistance
...
# --- Inlined from legacy.pulsar_identity_observer_distance (PulsarIdentityObserverDistance) ---
...
class PulsarIdentityObserverDistanceAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.PulsarIdentityObserverDistance."""
    ...
    def __init__(self):
        ...
        try:
            self._impl = PulsarIdentityObserverDistance(db_path=_DB_PATH)
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("PulsarIdentityObserverDistance",
                                  result.get("pulsar_identity_observer_distance", result))
        else:
            output = {"value": result}
