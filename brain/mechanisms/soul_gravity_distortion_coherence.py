...
class SOULGravityDistortionCoherence(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="SOULGravityDistortionCoherence", human_analog="SOULGravityDistortionCoherence", layer="integration")
        if db_path is None:
            import os
