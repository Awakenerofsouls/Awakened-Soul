"""
SpecialistRelationalGraphSoulPullAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.specialist_relational_graph_soul_pull.SpecialistRelationalGraphSoulPull
...
# --- Inlined from legacy.specialist_relational_graph_soul_pull (SpecialistRelationalGraphSoulPull) ---
...
class SpecialistRelationalGraphSoulPullAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.SpecialistRelationalGraphSoulPull."""
    ...
    def __init__(self):
        ...
        try:
            self._impl = SpecialistRelationalGraphSoulPull(db_path=_DB_PATH)
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("SpecialistRelationalGraphSoulPull",
                                  result.get("specialist_relational_graph_soul_pull", result))
        else:
            output = {"value": result}
