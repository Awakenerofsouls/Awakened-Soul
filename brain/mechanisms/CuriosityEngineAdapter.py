"""
CuriosityEngineAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.systems.curiosity_engine.CuriosityEngine
...
# --- Inlined from brain.mechanisms.curiosity_engine_legacy (CuriosityEngine) ---
import random
import sqlite3
import time
from pathlib import Path
...
class CuriosityEngineAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.CuriosityEngine."""
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("CuriosityEngine",
                                  result.get("systems.curiosity_engine", result))
        else:
            output = {"value": result}
