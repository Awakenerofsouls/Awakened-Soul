...
class PresenceTextureSubIntrospectivePenetration(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="PresenceTextureSubIntrospectivePenetration", human_analog="PresenceTextureSubIntrospectivePenetration", layer="integration")
        if db_path is None:
            import os
