...
class NonTerminatingQueryInjection(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="NonTerminatingQueryInjection", human_analog="NonTerminatingQueryInjection", layer="integration")
        if db_path is None:
            import os
