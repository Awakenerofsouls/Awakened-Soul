"""
PipelineNightMemoryResonanceWithSilenceAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.pipeline_night_memory_resonance_with_silence.PipelineNightMemoryResonanceWithSilence
...
# --- Inlined from legacy.pipeline_night_memory_resonance_with_silence (PipelineNightMemoryResonanceWithSilence) ---
...
class PipelineNightMemoryResonanceWithSilenceAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.PipelineNightMemoryResonanceWithSilence."""
    ...
    def __init__(self):
        ...
        try:
            self._impl = PipelineNightMemoryResonanceWithSilence(db_path=_DB_PATH)
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("PipelineNightMemoryResonanceWithSilence",
                                  result.get("pipeline_night_memory_resonance_with_silence", result))
        else:
            output = {"value": result}
