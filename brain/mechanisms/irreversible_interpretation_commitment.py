...
class IrreversibleInterpretationCommitment(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="IrreversibleInterpretationCommitment", human_analog="IrreversibleInterpretationCommitment", layer="integration")
        if db_path is None:
            import os
