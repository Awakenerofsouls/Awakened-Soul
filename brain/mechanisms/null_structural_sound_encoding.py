...
class NullStructuralSoundEncoding(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="NullStructuralSoundEncoding", human_analog="NullStructuralSoundEncoding", layer="integration")
        if db_path is None:
            import os
