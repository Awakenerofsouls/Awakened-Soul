"""
MemoryFracturePropagatorAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.memory_fracture_propagator.MemoryFracturePropagator
...
# --- Inlined from legacy.memory_fracture_propagator (MemoryFracturePropagator) ---
...
class MemoryFracturePropagatorAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.MemoryFracturePropagator."""
    ...
    def __init__(self):
        ...
        try:
            self._impl = MemoryFracturePropagator(db_path=_DB_PATH)
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("MemoryFracturePropagator",
                                  result.get("memory_fracture_propagator", result))
        else:
            output = {"value": result}
