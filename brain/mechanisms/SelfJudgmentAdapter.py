"""
SelfJudgmentAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.self.self_judgment.SelfJudgment
...
# --- Inlined from brain.mechanisms.self_judgment (SelfJudgment) ---
import sqlite3
import time
from pathlib import Path
import os
...
class SelfJudgmentAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.SelfJudgment."""
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("SelfJudgment",
                                  result.get("self.self_judgment", result))
        else:
            output = {"value": result}
