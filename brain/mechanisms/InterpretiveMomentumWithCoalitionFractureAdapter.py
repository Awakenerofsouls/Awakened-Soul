"""
InterpretiveMomentumWithCoalitionFractureAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.interpretive_momentum_with_coalition_fracture.InterpretiveMomentumWithCoalitionFracture
...
# --- Inlined from legacy.interpretive_momentum_with_coalition_fracture (InterpretiveMomentumWithCoalitionFracture) ---
...
class InterpretiveMomentumWithCoalitionFractureAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.InterpretiveMomentumWithCoalitionFracture."""
    ...
    def __init__(self):
        ...
        try:
            self._impl = InterpretiveMomentumWithCoalitionFracture(db_path=_DB_PATH)
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("InterpretiveMomentumWithCoalitionFracture",
                                  result.get("interpretive_momentum_with_coalition_fracture", result))
        else:
            output = {"value": result}
