"""
ThingBeforeThoughtAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.thing_before_thought.ThingBeforeThought
...
# --- Inlined from legacy.thing_before_thought (ThingBeforeThought) ---
#!/usr/bin/env python3
"""
...
class ThingBeforeThoughtAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.ThingBeforeThought."""
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("ThingBeforeThought",
                                  result.get("thing_before_thought", result))
        else:
            output = {"value": result}
