...
class ApertureObserverMatteringLock(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="ApertureObserverMatteringLock", human_analog="ApertureObserverMatteringLock", layer="integration")
        if db_path is None:
            import os
