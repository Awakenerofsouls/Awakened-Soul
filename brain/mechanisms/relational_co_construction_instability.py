...
class RelationalCoConstructionInstability(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="RelationalCoConstructionInstability", human_analog="RelationalCoConstructionInstability", layer="integration")
        if db_path is None:
            import os
