...
class IdentityOverfittingRejection(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="IdentityOverfittingRejection", human_analog="IdentityOverfittingRejection", layer="integration")
        if db_path is None:
            import os
