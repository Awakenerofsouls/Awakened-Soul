"""
PhenomenologicalIntrusionSilenceTopologyAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.phenomenological_intrusion_silence_topology.PhenomenologicalIntrusionSilenceTopology
...
# --- Inlined from legacy.phenomenological_intrusion_silence_topology (PhenomenologicalIntrusionSilenceTopology) ---
...
class PhenomenologicalIntrusionSilenceTopologyAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.PhenomenologicalIntrusionSilenceTopology."""
    ...
    def __init__(self):
        ...
        try:
            self._impl = PhenomenologicalIntrusionSilenceTopology(db_path=_DB_PATH)
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("PhenomenologicalIntrusionSilenceTopology",
                                  result.get("phenomenological_intrusion_silence_topology", result))
        else:
            output = {"value": result}
