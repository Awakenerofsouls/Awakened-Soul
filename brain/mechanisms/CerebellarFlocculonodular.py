...
class CerebellarFlocculonodular(BrainMechanism):
    ...
    The agent analog: maintaining orientation within a conversation, tracking where we are.
...
"""
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        # Context tracking — does the agent know where it is in the conversation?
