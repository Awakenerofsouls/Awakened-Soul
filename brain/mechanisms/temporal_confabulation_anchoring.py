...
class TemporalConfabulationAnchoring(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="TemporalConfabulationAnchoring", human_analog="TemporalConfabulationAnchoring", layer="integration")
        if db_path is None:
            import os
