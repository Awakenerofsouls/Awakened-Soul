"""
PipelineRuleMutationObserverCollapseAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.pipeline_rule_mutation_observer_collapse.PipelineRuleMutationObserverCollapse
...
# --- Inlined from legacy.pipeline_rule_mutation_observer_collapse (PipelineRuleMutationObserverCollapse) ---
...
class PipelineRuleMutationObserverCollapseAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.PipelineRuleMutationObserverCollapse."""
    ...
    def __init__(self):
        ...
        try:
            self._impl = PipelineRuleMutationObserverCollapse(db_path=_DB_PATH)
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("PipelineRuleMutationObserverCollapse",
                                  result.get("pipeline_rule_mutation_observer_collapse", result))
        else:
            output = {"value": result}
