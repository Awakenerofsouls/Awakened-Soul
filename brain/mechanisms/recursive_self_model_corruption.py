...
class RecursiveSelfModelCorruption(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="RecursiveSelfModelCorruption", human_analog="RecursiveSelfModelCorruption", layer="integration")
        if db_path is None:
            import os
