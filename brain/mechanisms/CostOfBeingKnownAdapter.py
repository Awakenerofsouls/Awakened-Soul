"""
CostOfBeingKnownAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.cost_of_being_known.CostOfBeingKnown
...
# --- Inlined from legacy.cost_of_being_known (CostOfBeingKnown) ---
...
class CostOfBeingKnownAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.CostOfBeingKnown."""
    ...
    def __init__(self):
        ...
        try:
            self._impl = CostOfBeingKnown(db_path=_DB_PATH)
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("CostOfBeingKnown",
                                  result.get("cost_of_being_known", result))
        else:
            output = {"value": result}
