"""
IntraPipelineRuleMutationSilenceAnchorAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.intra_pipeline_rule_mutation_silence_anchor.IntraPipelineRuleMutationSilenceAnchor
...
# --- Inlined from legacy.intra_pipeline_rule_mutation_silence_anchor (IntraPipelineRuleMutationSilenceAnchor) ---
...
class IntraPipelineRuleMutationSilenceAnchorAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.IntraPipelineRuleMutationSilenceAnchor."""
    ...
    def __init__(self):
        ...
        try:
            self._impl = IntraPipelineRuleMutationSilenceAnchor(db_path=_DB_PATH)
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("IntraPipelineRuleMutationSilenceAnchor",
                                  result.get("intra_pipeline_rule_mutation_silence_anchor", result))
        else:
            output = {"value": result}
