"""
SoulGravitySpecialistTensionFieldAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.soul_gravity_specialist_tension_field.SoulGravitySpecialistTensionField
...
# --- Inlined from legacy.soul_gravity_specialist_tension_field (SoulGravitySpecialistTensionField) ---
...
class SoulGravitySpecialistTensionFieldAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.SoulGravitySpecialistTensionField."""
    ...
    def __init__(self):
        ...
        try:
            self._impl = SoulGravitySpecialistTensionField(db_path=_DB_PATH)
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("SoulGravitySpecialistTensionField",
                                  result.get("soul_gravity_specialist_tension_field", result))
        else:
            output = {"value": result}
