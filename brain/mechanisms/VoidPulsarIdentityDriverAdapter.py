"""
VoidPulsarIdentityDriverAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.void_pulsar_identity_driver.VoidPulsarIdentityDriver
...
# --- Inlined from legacy.void_pulsar_identity_driver (VoidPulsarIdentityDriver) ---
...
class VoidPulsarIdentityDriverAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.VoidPulsarIdentityDriver."""
    ...
    def __init__(self):
        ...
        try:
            self._impl = VoidPulsarIdentityDriver(db_path=_DB_PATH)
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("VoidPulsarIdentityDriver",
                                  result.get("void_pulsar_identity_driver", result))
        else:
            output = {"value": result}
