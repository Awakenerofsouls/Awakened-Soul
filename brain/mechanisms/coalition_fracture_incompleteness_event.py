...
class CoalitionFractureIncompletenessEvent(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="CoalitionFractureIncompletenessEvent", human_analog="CoalitionFractureIncompletenessEvent", layer="integration")
        if db_path is None:
            import os
