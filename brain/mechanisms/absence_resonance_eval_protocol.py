...
class AbsenceResonanceEvalProtocol(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="AbsenceResonanceEvalProtocol", human_analog="AbsenceResonanceEvalProtocol", layer="integration")
        if db_path is None:
            import os
