...
class UnresolvablePreferenceSplit(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="UnresolvablePreferenceSplit", human_analog="UnresolvablePreferenceSplit", layer="integration")
        if db_path is None:
            import os
