"""
MultiGoalSchedulerAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.life.MultiGoalScheduler.MultiGoalScheduler
...
# --- Inlined from brain.mechanisms.MultiGoalScheduler (MultiGoalScheduler) ---
import sqlite3,time
from pathlib import Path
import os
...
class MultiGoalSchedulerAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.MultiGoalScheduler."""
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("MultiGoalScheduler",
                                  result.get("life.MultiGoalScheduler", result))
        else:
            output = {"value": result}
