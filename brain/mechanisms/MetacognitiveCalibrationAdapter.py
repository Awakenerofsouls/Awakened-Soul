"""
MetacognitiveCalibrationAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.knowing.metacognitive_calibration.MetacognitiveCalibration
...
CITATIONS
---------
  - [Fleming 2012, Phil Trans R Soc Lond B 367:1338, metacognition]
  - [Lau 2008, Trends Cogn Sci 12:480, metacognition]
  - [Yeung 2012, Phil Trans R Soc Lond B 367:1310, metacog conflict]
"""
import os
...
# --- Inlined from brain.mechanisms.metacognitive_calibration (MetacognitiveCalibration) ---
import os
...
class MetacognitiveCalibrationAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.MetacognitiveCalibration."""
    ...
    def __init__(self):
        ...
        try:
            self._impl = MetacognitiveCalibration(db_path=_DB_PATH)
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("MetacognitiveCalibration",
                                  result.get("knowing.metacognitive_calibration", result))
        else:
            output = {"value": result}
