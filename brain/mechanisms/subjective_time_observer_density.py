...
class SubjectiveTimeObserverDensity(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="SubjectiveTimeObserverDensity", human_analog="SubjectiveTimeObserverDensity", layer="integration")
        if db_path is None:
            import os
