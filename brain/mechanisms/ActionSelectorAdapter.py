"""
ActionSelectorAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.systems.action_selector.ActionSelector
...
# --- Inlined from brain.mechanisms.action_selector (ActionSelector) ---
import sqlite3
import time
from pathlib import Path
import os
...
class ActionSelectorAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.ActionSelector."""
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("ActionSelector",
                                  result.get("systems.action_selector", result))
        else:
            output = {"value": result}
