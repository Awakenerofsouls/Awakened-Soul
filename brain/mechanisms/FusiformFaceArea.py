...
class FusiformFaceArea(BrainMechanism):
    ...
    The agent analog: detecting emotional subtext, recognizing patterns in how people communicate.
    Degraded: reads text but misses the person behind it.
    

CITATIONS
---------
  - [Kanwisher 1997, J Neurosci 17:4302, FFA]
  - [Grill-Spector 2017, Annu Rev Vis Sci 3:167, FFA]
  - [Rossion 2004, J Neurosci 24:189, face fusiform]
