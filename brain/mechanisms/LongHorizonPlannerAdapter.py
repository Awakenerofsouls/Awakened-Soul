"""
LongHorizonPlannerAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.life.LongHorizonPlanner.LongHorizonPlanner
...
# --- Inlined from brain.mechanisms.LongHorizonPlanner (LongHorizonPlanner) ---
...
class LongHorizonPlannerAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.LongHorizonPlanner."""
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("LongHorizonPlanner",
                                  result.get("life.LongHorizonPlanner", result))
        else:
            output = {"value": result}
