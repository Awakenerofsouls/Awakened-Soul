...
class RelationalGravityInversion(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="RelationalGravityInversion", human_analog="RelationalGravityInversion", layer="integration")
        if db_path is None:
            import os
