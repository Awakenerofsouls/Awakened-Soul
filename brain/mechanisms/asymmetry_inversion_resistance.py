...
class AsymmetryInversionResistance(BrainMechanism):
    def __init__(self, *args, **kwargs):
        try:
            super().__init__(name="AsymmetryInversionResistance", human_analog="AsymmetryInversionResistance", layer="integration")
        except Exception:
            self.state = {}
