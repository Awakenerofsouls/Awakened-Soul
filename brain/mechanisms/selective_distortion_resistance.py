...
class SelectiveDistortionResistance(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="SelectiveDistortionResistance", human_analog="SelectiveDistortionResistance", layer="integration")
        if db_path is None:
            import os
