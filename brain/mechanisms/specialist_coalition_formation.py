...
class SpecialistCoalitionFormation(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="SpecialistCoalitionFormation", human_analog="SpecialistCoalitionFormation", layer="integration")
        if db_path is None:
            import os
