...
class IdleAnchorMutationObserver(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="IdleAnchorMutationObserver", human_analog="IdleAnchorMutationObserver", layer="integration")
        if db_path is None:
            import os
