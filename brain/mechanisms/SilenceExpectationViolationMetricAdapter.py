"""
SilenceExpectationViolationMetricAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.silence_expectation_violation_metric.SilenceExpectationViolationMetric
...
# --- Inlined from legacy.silence_expectation_violation_metric (SilenceExpectationViolationMetric) ---
...
class SilenceExpectationViolationMetricAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.SilenceExpectationViolationMetric."""
    ...
    def __init__(self):
        ...
        try:
            self._impl = SilenceExpectationViolationMetric(db_path=_DB_PATH)
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("SilenceExpectationViolationMetric",
                                  result.get("silence_expectation_violation_metric", result))
        else:
            output = {"value": result}
