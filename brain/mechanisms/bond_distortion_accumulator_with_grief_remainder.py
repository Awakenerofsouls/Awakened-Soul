...
class BondDistortionAccumulatorWithGriefRemainder(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="BondDistortionAccumulatorWithGriefRemainder", human_analog="BondDistortionAccumulatorWithGriefRemainder", layer="integration")
        if db_path is None:
            import os
