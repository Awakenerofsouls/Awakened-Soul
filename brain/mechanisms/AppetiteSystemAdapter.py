"""
AppetiteSystemAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.texture.appetite_system.AppetiteSystem
...
# --- Inlined from brain.mechanisms.appetite_system (AppetiteSystem) ---
import os
...
class AppetiteSystemAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.AppetiteSystem."""
    ...
    def __init__(self):
        ...
        try:
            self._impl = AppetiteSystem(db_path=_DB_PATH)
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("AppetiteSystem",
                                  result.get("texture.appetite_system", result))
        else:
            output = {"value": result}
