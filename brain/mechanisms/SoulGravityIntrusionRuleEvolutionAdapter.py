"""
SoulGravityIntrusionRuleEvolutionAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.soul_gravity_intrusion_rule_evolution.SoulGravityIntrusionRuleEvolution
...
# --- Inlined from legacy.soul_gravity_intrusion_rule_evolution (SoulGravityIntrusionRuleEvolution) ---
...
class SoulGravityIntrusionRuleEvolutionAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.SoulGravityIntrusionRuleEvolution."""
    ...
    def __init__(self):
        ...
        try:
            self._impl = SoulGravityIntrusionRuleEvolution(db_path=_DB_PATH)
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("SoulGravityIntrusionRuleEvolution",
                                  result.get("soul_gravity_intrusion_rule_evolution", result))
        else:
            output = {"value": result}
