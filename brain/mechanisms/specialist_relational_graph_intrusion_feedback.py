...
class SpecialistRelationalGraphIntrusionFeedback(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="SpecialistRelationalGraphIntrusionFeedback", human_analog="SpecialistRelationalGraphIntrusionFeedback", layer="integration")
        if db_path is None:
            import os
