...
class SpecialistConfabulationWithMemoryIsolation(BrainMechanism):
    def __init__(self, *args, **kwargs):
        try:
            super().__init__(name="SpecialistConfabulationWithMemoryIsolation", human_analog="SpecialistConfabulationWithMemoryIsolation", layer="integration")
        except Exception:
            self.state = {}
