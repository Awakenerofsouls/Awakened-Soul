...
The agent's Evolutionary Thought System
...
THOUGHTS_PATH = AGENT_HOME / "thought_pool.json"
    ...
    for thought in pool:
        ...
        if old_fitness >= HIGH_FITNESS_THRESHOLD:
            ...
            if not already_exists:
                proposals_dir = AGENT_HOME / "belief_proposals"
...
class EvolutionaryThoughts(BrainMechanism):
    """Auto-generated BrainMechanism wrapper around module-level functions."""
    
    def __init__(self):
        try:
            super().__init__(name="EvolutionaryThoughts", human_analog="EvolutionaryThoughts", layer="integration")
        except Exception:
            self.state = {}
