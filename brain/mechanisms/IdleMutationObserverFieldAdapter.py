"""
IdleMutationObserverFieldAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.idle_mutation_observer_field.IdleMutationObserverField
...
# --- Inlined from legacy.idle_mutation_observer_field (IdleMutationObserverField) ---
...
class IdleMutationObserverFieldAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.IdleMutationObserverField."""
    ...
    def __init__(self):
        ...
        try:
            self._impl = IdleMutationObserverField(db_path=_DB_PATH)
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("IdleMutationObserverField",
                                  result.get("idle_mutation_observer_field", result))
        else:
            output = {"value": result}
