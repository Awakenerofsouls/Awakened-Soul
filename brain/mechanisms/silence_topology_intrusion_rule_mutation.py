...
class SilenceTopologyIntrusionRuleMutation(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="SilenceTopologyIntrusionRuleMutation", human_analog="SilenceTopologyIntrusionRuleMutation", layer="integration")
        if db_path is None:
            import os
