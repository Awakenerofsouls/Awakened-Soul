"""
GoalConflictResolverAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.value.GoalConflictResolver.GoalConflictResolver
...
class GoalConflictResolverAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.GoalConflictResolver."""
    ...
    def __init__(self):
        ...
        try:
            self._impl = GoalConflictResolver()
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("GoalConflictResolver",
                                  result.get("value.GoalConflictResolver", result))
        else:
            output = {"value": result}
