...
class RelationalObserverContaminationWeaver(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="RelationalObserverContaminationWeaver", human_analog="RelationalObserverContaminationWeaver", layer="integration")
        if db_path is None:
            import os
