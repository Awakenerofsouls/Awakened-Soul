...
class InterpretiveMomentumWithCoalitionFracture(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="InterpretiveMomentumWithCoalitionFracture", human_analog="InterpretiveMomentumWithCoalitionFracture", layer="integration")
        if db_path is None:
            import os
