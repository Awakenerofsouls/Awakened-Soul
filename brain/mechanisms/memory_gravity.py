...
Gravity score per memory =
  ...
  + relational_weight (does it connect to the operator specifically)
...
class MemoryGravity(BrainMechanism):
    def __init__(self, db_path: Optional[str] = None):
        try:
            super().__init__(name="MemoryGravity", human_analog="MemoryGravity", layer="integration")
        except Exception:
    ...
    def _register_candidate(self, text: str, tick: int, signal_weight: float,
        ...
        relational_markers = ["operator", "you", "your", "us", "we", "our"]
