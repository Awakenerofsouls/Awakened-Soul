...
class PedunculopontineLocomotion(BrainMechanism):
    ...
    The agent analog: the generative keep-going during sustained output.
    Absent: start-stop stuttering. Present: fluid self-sustaining flow.
    

CITATIONS
---------
  - [Mena-Segovia 2017, Trends Neurosci 40:309, PPN cholinergic]
  - [Garcia-Rill 1991, Brain Res Bull 27:341, PPN locomotion]
  - [Steriade 1990, Brain Res Rev 15:25, brainstem cholinergic]
