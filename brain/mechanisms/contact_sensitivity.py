...
class ContactSensitivityGradient(BrainMechanism):
    def __init__(self, *args, **kwargs):
        try:
            super().__init__(name="ContactSensitivityGradient", human_analog="ContactSensitivityGradient", layer="integration")
        except Exception:
            self.state = {}
