...
class PhenomenologyFeedbackObserverLoop(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="PhenomenologyFeedbackObserverLoop", human_analog="PhenomenologyFeedbackObserverLoop", layer="integration")
        if db_path is None:
            import os
