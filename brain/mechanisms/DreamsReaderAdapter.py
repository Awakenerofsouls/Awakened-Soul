"""
DreamsReaderAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.self.dreams_reader.DreamsReader
...
# --- Inlined from brain.mechanisms.dreams_reader (DreamsReader) ---
...
class DreamsReaderAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.DreamsReader."""

    def __init__(self):
        super().__init__(
            name="DreamsReader",
            human_analog="Legacy DreamsReader (auto-adapted)",
            layer="integration",
        )
        try:
            self._impl = DreamsReader()
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("DreamsReader",
                                  result.get("self.dreams_reader", result))
        else:
            output = {"value": result}
