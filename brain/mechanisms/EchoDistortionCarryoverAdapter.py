"""
EchoDistortionCarryoverAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.echo_distortion_carryover.EchoDistortionCarryover
...
# --- Inlined from legacy.echo_distortion_carryover (EchoDistortionCarryover) ---
#!/usr/bin/env python3
"""
...
class EchoDistortionCarryoverAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.EchoDistortionCarryover."""
    ...
    def __init__(self):
        ...
        try:
            self._impl = EchoDistortionCarryover()
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("EchoDistortionCarryover",
                                  result.get("echo_distortion_carryover", result))
        else:
            output = {"value": result}
