...
class ExplanatoryConfabulationWithSubIntrospectiveAnchor(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="ExplanatoryConfabulationWithSubIntrospectiveAnchor", human_analog="ExplanatoryConfabulationWithSubIntrospectiveAnchor", layer="integration")
        if db_path is None:
            import os
