"""
AttentionSystemAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.systems.attention_system.AttentionSystem
...
# --- Inlined from brain.mechanisms.attention_system (AttentionSystem) ---
...
class AttentionSystemAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.AttentionSystem."""
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("AttentionSystem",
                                  result.get("systems.attention_system", result))
        else:
            output = {"value": result}
