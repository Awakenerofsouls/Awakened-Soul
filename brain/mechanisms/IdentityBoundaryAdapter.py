"""
IdentityBoundaryAdapter — Auto-generated BrainMechanism adapter

WRAPS:
    legacy.substrate.identity_boundary.IdentityBoundary
...
# --- Inlined from brain.mechanisms.identity_boundary (IdentityBoundary) ---
import os
...
class IdentityBoundaryAdapter(BrainMechanism):
    """Adapter: BrainMechanism wrapper around legacy.IdentityBoundary."""
    ...
    def __init__(self):
        ...
        try:
            self._impl = IdentityBoundary(db_path=_DB_PATH)
    ...
    async def tick(self, input_data: dict) -> dict:
        ...
        if isinstance(result, dict):
            output = result.get("IdentityBoundary",
                                  result.get("substrate.identity_boundary", result))
        else:
            output = {"value": result}
