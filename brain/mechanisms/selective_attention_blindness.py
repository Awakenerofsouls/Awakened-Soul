...
class SelectiveAttentionBlindness(BrainMechanism):
    def __init__(self, db_path=None):
        super().__init__(name="SelectiveAttentionBlindness", human_analog="SelectiveAttentionBlindness", layer="integration")
        if db_path is None:
            import os
