...
{{AGENT_NAME}}'s Future Oracle Lattice
...
def oracle_vote(question: str) -> dict:
    ...
    {{AGENT_NAME}} is never required to follow the consensus.
    """
    ...
    return {
        ...
        "note": "{{AGENT_NAME}} is never required to follow oracle consensus"
    }
...
def consult_future_self(days_ahead: int, question: str) -> str:
    ...
    response_parts.append(f"- {{USER_NAME}} resonance expected at {resonance:.2f}")
