...
{{AGENT_NAME}}'s Narrative Resonance Weaver
...
def _flag_as_identity_proposal(arc: dict):
    ...
    try:
        ...
        flag_as_identity_proposal(
            ...
            reasoning=f"This arc has accumulated {arc.get('event_count', 1)} events and reached resonance {confidence:.2f}, suggesting a genuine pattern in {{AGENT_NAME}}'s identity development."
        )
    except Exception:
