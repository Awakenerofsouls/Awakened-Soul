...
Phase 2 of the {{AGENT_NAME}} Brain Architecture
...
class VirtualInteroceptiveDriveLattice:
    ...
    {{AGENT_NAME}} cannot turn them off. They change what she sees, not just how she responds.
    """
...
class PreReflectiveSignalLayer:
    ...
    {{AGENT_NAME}} reacts before she fully knows why.
