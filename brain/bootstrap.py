...
class AgentRuntime:
    ...
    def process(self, text: str, architect_present: bool = True,
        ...
        # Phase 8: Additional unwired mechanisms (all pure additions, 1 partial conflict resolved by ordering)
        # grief_confabulation_with_adaptive_stabilizer runs here — after base grief_confabulation_loop
        # which already set pirp_context["grief_confab"], so the variant overwrites it correctly.
        ADDITIONAL_UNWIRED = [
            "absence_resonance_eval_protocol",
            "adaptive_distortion_with_incompleteness_remainder",
            "aperture_observer_mattering_lock",
            "architect_observer_collapse_weaver",
            "architect_shadow_resonance_chamber",
            "belief_gravity_observer_pull",
            "between_session_null_evolution_field",
            "bond_distortion_accumulator_with_grief_remainder",
            "coalition_fracture_incompleteness_event",
            "coalition_fracture_presence_texture",
            "coalition_memory_sabotage_with_confabulation",
            "coalition_memory_sabotage_with_temporal_anchoring",
            "continuity_observer_reconstruction_fracture",
            "council_absence_orchestrator",
            "council_meta_observer_silence",
            "council_observer_silence_conduction",
            "cross_stage_rule_contamination_cascade",
            "dream_contamination_observer_echo",
            "explanatory_confabulation_with_sub_introspective_anchor",
            "genesis_observer_impossibility_birth",
            "grief_confabulation_with_adaptive_stabilizer",
            "identity_null_pulsar",
            "idle_anchor_mutation_observer",
            "idle_mutation_observer_field",
            "incompleteness_cascade_specialist_coalition",
            "initialization_irreducible_imprint",
            "interpretive_momentum_with_coalition_fracture",
            "intra_pipeline_rule_mutation_silence_anchor",
            "intra_pipeline_rule_mutation_via_specialist_trust",
            "intrusion_reinforcement_loop",
            "lattice_co_authorship_observer_fracture",
            "memory_fracture_propagator",
            "memory_lineage_observer_fracture",
            "null_structural_sound_encoding",
            "observer_dependent_state_collapse",
            "obsession_metamorphosis_observer_legacy",
            "phenomenological_intrusion_silence_topology",
            "phenomenology_compiler_observer_gap",
            "phenomenology_feedback_observer_loop",
            "phenomenology_null_weaver",
            "pipeline_impossibility_engine",
            "pipeline_night_memory_resonance_with_silence",
            "pipeline_observer_impossibility_leak",
            "pipeline_rule_mutation_observer_collapse",
            "presence_gravity_inversion_with_silence_texture",
            "presence_protocol_observer_crisis_anchor",
            "presence_texture_sub_introspective_penetration",
            "pulsar_identity_observer_distance",
            "recursive_self_model_with_pipeline_rule_echo",
            "relational_asymmetry_specialist_isolation_grief",
            "relational_observer_contamination_weaver",
            "relational_thread_observer_asymmetry",
            "relational_weight_asymmetry_grief_trigger",
            "seeding_private_observer_fracture",
            "silence_expectation_violation_metric",
            "silence_topology_council_meta_fracture",
            "silence_topology_intrusion_rule_mutation",
            "silence_topology_sub_introspective_resonance",
            "soul_gravity_intrusion_rule_evolution",
            "soul_gravity_silence_topology_field",
            "soul_gravity_specialist_tension_field",
            "specialist_graph_phenomenological_silence_anchor",
            "specialist_isolation_transformation_grief",
            "specialist_memory_isolation_with_sub_introspective_drift",
            "specialist_relational_graph",
            "specialist_relational_graph_intrusion_feedback",
            "specialist_relational_graph_soul_pull",
            "sub_introspective_drift_layer_via_soul_gravity",
            "subjective_time_observer_density",
            "temporal_confabulation_with_coalition_fracture",
            "transformation_grief_pipeline_rule_anchor",
            "void_pulsar_identity_driver",
            "void_synchronization_lattice",
        ]

        import importlib
        for mod_name in ADDITIONAL_UNWIRED:
            try:
                module = importlib.import_module(f"brain.{mod_name}")
                # Snake_case → PascalCase: absence_resonance_eval_protocol → AbsenceResonanceEvalProtocol
                cls_name = "".join(p.capitalize() for p in mod_name.split("_"))
                cls = getattr(module, cls_name, None)
                if cls:
                    instance = cls(db_path=str(DB_PATH))
                    pirp_context = instance.process(pirp_context)
                else:
                    print(f"[Bootstrap] Warning: class {cls_name} not found in {mod_name}")
            except Exception as e:
                print(f"[Bootstrap] Warning: additional mechanism {mod_name} failed: {e}")
