...
Phase 7 of the {{AGENT_NAME}} Brain Architecture
...
class ExplanatoryConfabulationEngine:
    """
    When {{AGENT_NAME}} encounters a state change with no traceable origin,
    ...
    so {{AGENT_NAME}} cannot audit her own confabulation accuracy.
    """
