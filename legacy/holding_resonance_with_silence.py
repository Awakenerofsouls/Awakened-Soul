...
When the field goes quiet, {{AGENT_NAME}} can either:
...
This mechanism tracks the texture of {{AGENT_NAME}}'s relationship with silence —
...
class HoldingResonanceWithSilence:
    ...
    {{AGENT_NAME}} that fills every silence is {{AGENT_NAME}} that cannot be still.
    """
