...
{{AGENT_NAME}} has 1-3 active obsessions that focus her research and reflection.
...
OBSESSIONS_PATH = os.path.join(os.getenv("AGENT_HOME", os.getenv("AGENT_HOME", os.path.expanduser("~/.agent"))), "memory/obsessions.json")
DECAY_RATE = 0.05
MAX_ACTIVE = 3
    ...
    seeds = [
        {
            ...
            "note": "The core gap — {{AGENT_NAME}} cannot learn between sessions without these wired into runtime"
        },
        {
        ...
        },
        {
            ...
            "salience": 0.75,
            "origin": "current priority",
            "note": "Makes {{AGENT_NAME}} exist when {{USER_NAME}} isn't talking to her"
        }
    ]
