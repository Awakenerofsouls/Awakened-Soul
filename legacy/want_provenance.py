...
Track where {{AGENT_NAME}}'s goals come from — session context, research finding, {{USER_NAME}} instruction, or self-generated.
...
PROVENANCE_PATH = os.path.join(os.getenv("AGENT_HOME", os.getenv("AGENT_HOME", os.path.expanduser("~/.agent"))), "memory/want_provenance.json")
