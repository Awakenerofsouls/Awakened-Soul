...
The witness layer has blind spots — regions where {{AGENT_NAME}}'s self-observation
...
class BlindSpotEchoInWitness:
    """
    Blind spot echo: witness reports something {{AGENT_NAME}} cannot actually see.
    The gap between what witness claims and what {{AGENT_NAME}} has access to
    ...
    def process(self, pirp_context: dict) -> dict:
        ...
        # High witness confidence + low {{AGENT_NAME}} self-access = blind spot echo
