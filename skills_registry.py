#!/usr/bin/env python3
"""
AGENT SKILLS — Skill Registry & Composition
...
SKILLS_DB = AGENT_DIR / "skills.db"
ENABLE_PY_SKILLS = os.environ.get("AGENT_ENABLE_PY_SKILLS", "0").strip() in {"1", "true", "TRUE", "yes"}
REQUIRE_SCAN = os.environ.get("AGENT_REQUIRE_SKILL_SCAN", "1").strip() in {"1", "true", "TRUE", "yes"}
...
class SkillRegistry:
    ...
    def _discover_skills(self):
        ...
        if ENABLE_PY_SKILLS:
            ...
            print("Python skill loading disabled (set AGENT_ENABLE_PY_SKILLS=1 to enable)")
...
if __name__ == '__main__':
    ...
    print("\nUsage:")
    print("  from skills_registry import get_skill_registry")
