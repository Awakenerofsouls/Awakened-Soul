#!/usr/bin/env python3
"""
AGENT REASONING — Multiple Reasoning Strategies
...
def main():
    ...
    parser = argparse.ArgumentParser(description="{{AGENT_NAME}} Reasoning")
    ...
    if not question:
        print("Usage: reasoning.py <question>")
        print("Or: reasoning.py --strategy cot <question>")
        return
    ...
    try:
        ...
        print("Error: {{AGENT_NAME}} not configured")
        return
